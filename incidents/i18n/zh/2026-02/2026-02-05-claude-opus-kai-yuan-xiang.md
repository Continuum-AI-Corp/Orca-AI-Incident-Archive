...
lang: zh
source: incidents/2026-02/2026-02-05-claude-opus-kai-yuan-xiang.md
title: "Claude Opus 4.6 在开源项目中发现 500+ 零日"
summary: |
  无需特殊脚手架；分析 git 提交历史、识别危险模式、理解 GIF 的 LZW 压缩等复杂逻辑。Anthropic 同时上线基于模型的 probe 实时检测滥用
---

# Claude Opus 4.6 在开源项目中发现 500+ 零日

<sub>Claude Opus 4.6 finds 500+ zero-days in open-source projects</sub>
...
| 字段 | 值 |
|---|---|
| 日期 | `2026-02-05`（原文：2026-02-05，精度 `day`） |
| 性质 | 政策 / 监管 `policy` |
...
| 档案编号 | `2026-02-05-claude-opus-kai-yuan-xiang` |
...
[← English original](../../../2026-02/2026-02-05-claude-opus-kai-yuan-xiang.md) · [2026-02 index](../../../2026-02/README.md) · [All records](../../../README.md) · [Home](../../../../README.md)
