...
lang: zh
source: incidents/2025-01/2025-01-23-operator-fa-bu-bei-jing.md
title: "OpenAI Operator 发布（背景条目）"
summary: |
  首个面向消费者的计算机使用 agent，02-01 向美国 Pro 用户开放研究预览。**System Card 中已把提示注入列为发布前外部红队与前沿风险评估的重点** —— 这是本档案里「厂商在发布时就知道提示注入是核心风险」的最早一笔
---

# OpenAI Operator 发布（背景条目）

<sub>OpenAI Operator launches (context entry)</sub>
...
| 字段 | 值 |
|---|---|
| 日期 | `2025-01-23`（原文：2025-01-23，精度 `day`） |
| 性质 | 政策 / 监管 `policy` |
...
| 档案编号 | `2025-01-23-operator-fa-bu-bei-jing` |
...
[← English original](../../../2025-01/2025-01-23-operator-fa-bu-bei-jing.md) · [2025-01 index](../../../2025-01/README.md) · [All records](../../../README.md) · [Home](../../../../README.md)
