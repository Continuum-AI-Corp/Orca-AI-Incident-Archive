...
lang: zh
source: incidents/2026-06/2026-06-25-gpt-sol-xian-ding-yu.md
title: "OpenAI GPT-5.6 Sol 限定预览"
summary: |
  应美国政府要求先给少数可信伙伴。第三方 **Irregular** 评估（解除部署缓解的能力引出条件下）：Sol 在多个真实系统上发现并利用了高影响零日，但**最严重的那个 GPT-5.5 也能发现，不构成新阈值**；对加固目标与端到端自主作战仍有限
---

# OpenAI GPT-5.6 Sol 限定预览

<sub>OpenAI GPT-5.6 Sol limited preview</sub>
...
| 字段 | 值 |
|---|---|
| 日期 | `2026-06-25`（原文：2026-06-25，精度 `day`） |
| 性质 | 政策 / 监管 `policy` |
...
| 档案编号 | `2026-06-25-gpt-sol-xian-ding-yu` |
...
[← English original](../../../2026-06/2026-06-25-gpt-sol-xian-ding-yu.md) · [2026-06 index](../../../2026-06/README.md) · [All records](../../../README.md) · [Home](../../../../README.md)
