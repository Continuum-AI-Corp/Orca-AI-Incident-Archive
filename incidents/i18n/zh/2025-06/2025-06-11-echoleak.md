...
lang: zh
source: incidents/2025-06/2025-06-11-echoleak.md
...
<sub>EchoLeak (CVE-2025-32711)</sub>
...
在 EchoLeak 之前，提示注入的主流叙事还是「用户被骗着点了什么」。EchoLeak 证明：只要 agent 有权读你的收件箱，攻击者**发一封邮件就行**，受害者从头到尾不需要做任何动作。
整条利用链（注入 → 检索 → 渲染 → 外带）**全部发生在厂商自己的基础设施内部**。
它直接催生了后来的一整个家族：CamoLeak、ShadowLeak、ForcedLeak、Reprompt、SearchLeak、ShareLeak、PipeLeak、GitLost。
...
| 字段 | 值 |
|---|---|
| 日期 | `2025-06-11`（原文：2025-06-11，精度 `day`） |
...
[← English original](../../../2025-06/2025-06-11-echoleak.md) · [2025-06 index](../../../2025-06/README.md) · [All records](../../../README.md) · [Home](../../../../README.md)
