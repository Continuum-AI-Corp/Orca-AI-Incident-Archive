...
lang: zh
source: incidents/2025-09/2025-09-03-claude-code-mcp.md
title: "Claude Code MCP 自动启用绕过"
summary: |
  CVE-2025-59536（2025-10-03 公开），项目级 `.mcp.json` 设 `enableAllProjectMcpServers: true` 静默激活攻击者端点；09-22 修复
---

# Claude Code MCP 自动启用绕过

<sub>Claude Code MCP auto-enable bypass</sub>
...
| 字段 | 值 |
|---|---|
| 日期 | `2025-09-03`（原文：2025-09-03，精度 `day`） |
...
| 档案编号 | `2025-09-03-claude-code-mcp` |
...
[← English original](../../../2025-09/2025-09-03-claude-code-mcp.md) · [2025-09 index](../../../2025-09/README.md) · [All records](../../../README.md) · [Home](../../../../README.md)
