...
lang: zh
source: incidents/2026-04/2026-04-14-vidoc-mythos-yong-gong-kai.md
title: "Vidoc：用公开模型复现了 Mythos 的发现"
summary: |
  小型开源模型 + 专家设计的脚手架即可复现 FreeBSD NFS 利用、OpenBSD 27 年前的 SACK bug。**说明能力边界是「锯齿状(jagged)」的，不是前沿模型独占**
---

# Vidoc：用公开模型复现了 Mythos 的发现

<sub>Vidoc reproduces Mythos's findings with public models</sub>
...
| 字段 | 值 |
|---|---|
| 日期 | `2026-04-14`（原文：2026-04-14，精度 `day`） |
| 性质 | 政策 / 监管 `policy` |
...
| 档案编号 | `2026-04-14-vidoc-mythos-yong-gong-kai` |
...
[← English original](../../../2026-04/2026-04-14-vidoc-mythos-yong-gong-kai.md) · [2026-04 index](../../../2026-04/README.md) · [All records](../../../README.md) · [Home](../../../../README.md)
