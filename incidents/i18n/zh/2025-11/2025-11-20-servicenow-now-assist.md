...
lang: zh
source: incidents/2025-11/2025-11-20-servicenow-now-assist.md
title: "ServiceNow Now Assist 二阶提示注入"
summary: |
  AppOmni：agent 之间互相发指令，低权限 agent 可驱使高权限 agent 改记录、发邮件、提权
---

# ServiceNow Now Assist 二阶提示注入

<sub>ServiceNow Now Assist second-order prompt injection</sub>
...
| 字段 | 值 |
|---|---|
| 日期 | `2025-11-20`（原文：2025-11-20，精度 `day`） |
| 性质 | 研究演示 `research` |
...
| 档案编号 | `2025-11-20-servicenow-now-assist` |
...
[← English original](../../../2025-11/2025-11-20-servicenow-now-assist.md) · [2025-11 index](../../../2025-11/README.md) · [All records](../../../README.md) · [Home](../../../../README.md)
