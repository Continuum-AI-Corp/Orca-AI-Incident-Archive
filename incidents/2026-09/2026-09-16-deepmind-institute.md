...
title: "Google DeepMind launches the DeepMind Institute for AGI governance"
title_zh: "Google DeepMind 成立 DeepMind Institute，聚焦 AGI 治理"
title_ja: "Google DeepMind、AGIガバナンスのDeepMind Instituteを設立"
title_ko: "Google DeepMind, AGI 거버넌스 위한 DeepMind Institute 출범"
title_de: "Google DeepMind gründet das DeepMind Institute für AGI-Governance"
title_fr: "Google DeepMind lance le DeepMind Institute pour la gouvernance de l'AGI"
title_es: "Google DeepMind lanza el DeepMind Institute para la gobernanza de la AGI"
date: 2026-09-16
date_precision: day
date_raw: "2026-09-16"
...
```mermaid
flowchart LR
    E["Frontier lab publishes named governance mechanisms"]:::entry
    S0["30-day pre-release review, held-out tests, serial-depth caps proposed"]:::step
    I["AI governance debate gains concrete, testable proposals"]:::impact
    E --> S0 --> I
...
<sub>**Why this classification:** Vendor policy publication, not an incident; `severity` is recorded as `info`. Grading criteria: see [taxonomy/severity.md](../../taxonomy/severity.md) and [taxonomy/confidence.md](../../taxonomy/confidence.md).</sub>
...
- `2026-09-18` [Consumers sue Anthropic, OpenAI, SpaceXAI and Google over an alleged AI slowdown pact](2026-09-18-ai-slowdown-antitrust-lawsuit.md)<br>  <sub>Consumers sue Anthropic, OpenAI, SpaceXAI and Google over an alleged AI slowdown pact</sub>
