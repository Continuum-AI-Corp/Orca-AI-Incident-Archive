...
|  |  |
|---|---|
| Source links | 589 links across 522 unique URLs |
| Records with no source | **0** — no source, no entry |
| Grade A (primary source) | 286 |
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {333 records, 2025-01 to 2026-09; 124 with confirmed real-world harm},
...
<sub><!-- BEGIN:footer -->Built 2026-09-19 · 333 records · 22 months<!-- END:footer --></sub> · <sub>Structure: [SCHEMA.md](SCHEMA.md) · Data: [dist/](dist/README.md)</sub>
