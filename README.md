...
|  |  |
|---|---|
| Source links | 684 links across 614 unique URLs |
| Records with no source | **0** — no source, no entry |
| Grade A (primary source) | 309 |
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {361 records, 2025-01 to 2026-09; 130 with confirmed real-world harm},
...
<sub><!-- BEGIN:footer -->Built 2026-09-24 · 361 records · 22 months<!-- END:footer --></sub> · <sub>Structure: [SCHEMA.md](SCHEMA.md) · Data: [dist/](dist/README.md)</sub>
