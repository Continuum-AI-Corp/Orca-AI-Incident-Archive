...
| <a id="ipi"></a>`IPI` | Indirect prompt injection | Indirect prompt injection | 46 | **External content** the agent reads is executed as instructions. The deciding factor is that the injection source is outside the user's control (email, issue, web page, document, dataset). |
