...
|---|---|---|---|
| `incident` Incident | 142 | A real-world event (whether or not there was an attacker) | Yes |
...
| `research` Research demo | 87 | A controlled demonstration by a research organisation or a vendor. Listed to mark **when an attack surface became public** | No |
...
|---|---|---|
| `true` | 130 | There is a **confirmed victim**: an organisation, data, funds or a system suffered actual damage |
| `false` | 145 | A research demo, or a vulnerability that was fixed with no known exploitation in the wild |
...
| Value | Records | Meaning |
|---|---|---|
| `confirmed` Confirmed | 351 | A primary source confirms AI involvement |
