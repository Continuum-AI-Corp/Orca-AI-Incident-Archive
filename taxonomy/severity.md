...
| ![high](https://img.shields.io/badge/severity-high-B23B40?style=flat-square) **High** | 148 | Confirmed real damage of limited scope; or a severe flaw at CVSS 9+ (even with no known exploitation in the wild); or a significant capability demonstration | [EchoLeak](../incidents/2025-06/2025-06-11-echoleak.md) (CVSS 9.3, no known in-the-wild exploitation) |
| ![medium](https://img.shields.io/badge/severity-medium-C4615F?style=flat-square) **Medium** | 84 | A controlled demonstration, a moderate flaw, or an incident scoped to a single user / single machine | Most research demos and single-machine rogue incidents |
...
|---|---|---|---|
| `incident` Incident | 146 | A real-world event (whether or not there was an attacker) | Yes |
...
|---|---|---|
| `true` | 134 | There is a **confirmed victim**: an organisation, data, funds or a system suffered actual damage |
| `false` | 153 | A research demo, or a vulnerability that was fixed with no known exploitation in the wild |
...
| Value | Records | Meaning |
|---|---|---|
| `confirmed` Confirmed | 363 | A primary source confirms AI involvement |
