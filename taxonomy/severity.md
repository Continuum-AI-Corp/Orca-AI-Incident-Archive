...
| ![medium](https://img.shields.io/badge/severity-medium-C4615F?style=flat-square) **Medium** | 79 | A controlled demonstration, a moderate flaw, or an incident scoped to a single user / single machine | Most research demos and single-machine rogue incidents |
...
| `false` | 146 | A research demo, or a vulnerability that was fixed with no known exploitation in the wild |
...
| Value | Records | Meaning |
|---|---|---|
| `confirmed` Confirmed | 352 | A primary source confirms AI involvement |
