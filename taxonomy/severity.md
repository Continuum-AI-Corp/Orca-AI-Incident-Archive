...
|---|---|---|---|
| `incident` Incident | 141 | A real-world event (whether or not there was an attacker) | Yes |
...
| `research` Research demo | 86 | A controlled demonstration by a research organisation or a vendor. Listed to mark **when an attack surface became public** | No |
...
|---|---|---|
| `true` | 129 | There is a **confirmed victim**: an organisation, data, funds or a system suffered actual damage |
| `false` | 144 | A research demo, or a vulnerability that was fixed with no known exploitation in the wild |
...
| Value | Records | Meaning |
|---|---|---|
| `confirmed` Confirmed | 349 | A primary source confirms AI involvement |
