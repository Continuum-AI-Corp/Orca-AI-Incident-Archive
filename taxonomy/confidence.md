...
|---|---|---|
| ![A](https://img.shields.io/badge/confidence-A-157A41?style=flat-square) **A** | 302 | Primary source: a vendor advisory, an affected party's disclosure, a law-enforcement filing, an official report PDF |
