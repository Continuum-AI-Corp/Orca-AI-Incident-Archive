...
|---|---|---|
| ![A](https://img.shields.io/badge/confidence-A-157A41?style=flat-square) **A** | 272 | Primary source: a vendor advisory, an affected party's disclosure, a law-enforcement filing, an official report PDF |
| ![B](https://img.shields.io/badge/confidence-B-2359A8?style=flat-square) **B** | 37 | Reporting by a research organisation or mainstream media, with checkable technical detail |
...
| ![D](https://img.shields.io/badge/confidence-D-A82B39?style=flat-square) **D** | 2 | Key facts or attribution are disputed; all sides must be presented side by side |
