...
<!-- BEGIN:badges -->
<p align="center"><img alt="entrées" src="https://img.shields.io/badge/entr%C3%A9es-365-48545A?style=flat-square"> <img alt="mois" src="https://img.shields.io/badge/mois-22-48545A?style=flat-square"> <img alt="critiques" src="https://img.shields.io/badge/critiques-47-88091D?style=flat-square"> <img alt="préjudice réel" src="https://img.shields.io/badge/pr%C3%A9judice_r%C3%A9el-133-B23B40?style=flat-square"> <img alt="sources primaires" src="https://img.shields.io/badge/sources_primaires-625_URL-157A41?style=flat-square"> <img alt="licence" src="https://img.shields.io/badge/licence-CC_BY_4.0-2359A8?style=flat-square"></p>
<!-- END:badges -->

<!-- BEGIN:thesis -->
La couverture va de **2025-01** à **2026-09-24** — 365 entrées d'événements de sécurité liés aux agents IA, mois par mois, plus un précurseur remontant à 2024-12-01. Chaque entrée est un fichier Markdown unique avec un en-tête YAML, un schéma de chaîne d'attaque et **au moins une source primaire cliquable**. Sur ces 365 entrées, seules **133 ont une victime confirmée**.
<!-- END:thesis -->
...
|---|---|---|---|---|---|---|---|---|
| `13` ★1 | `19` ★5 | `16` ★3 | `22` ★2 | `26` ★5 | `31` ★3 | `28` ★7 | `26` ★4 | `62` ★8 |
...
|  |  |
|---|---|
| Liens sources | 695 liens sur 625 URL uniques |
| Entrées sans source | **0** — pas de source, pas d'entrée |
| Grade A (source primaire) | 311 |
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {365 entrées, de 2025-01 à 2026-09 ; 133 avec préjudice réel confirmé},
...
<sub><!-- BEGIN:footer -->Généré le 2026-09-24 · 365 entrées · 22 mois<!-- END:footer --></sub> · <sub>Structure : [SCHEMA.md](../../SCHEMA.md) · Données : [dist/](../../dist/README.md)</sub>
