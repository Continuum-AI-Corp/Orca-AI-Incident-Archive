...
<!-- BEGIN:thesis -->
수록 범위는 **2025-01**부터 **2026-09-19**까지입니다. AI 에이전트와 관련된 보안 사건 330건을 월별로 정리했습니다(2024-12-01까지 거슬러 올라가는 선행 사건 1건 포함). 각 레코드는 YAML 헤더, 공격 체인 도식, 그리고 **클릭할 수 있는 1차 출처 최소 1개**를 갖춘 Markdown 파일입니다. 330건 중 확인된 피해자가 있는 것은 **124건**뿐입니다.
<!-- END:thesis -->
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {330건, 2025-01~2026-09, 124건은 확인된 실제 피해},
...
<sub><!-- BEGIN:footer -->빌드 2026-09-19 · 330건 · 22개월<!-- END:footer --></sub> · <sub>구조: [SCHEMA.md](../../SCHEMA.md) · 데이터: [dist/](../../dist/README.md)</sub>
