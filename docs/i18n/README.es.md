...
|  |  |
|---|---|
| Enlaces de fuentes | 552 enlaces de 485 URL únicas |
| Registros sin fuente | **0** — sin fuente no hay registro |
| Grado A (fuente primaria) | 280 |
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {323 registros, de 2025-01 a 2026-09; 123 con daño real confirmado},
...
<sub><!-- BEGIN:footer -->Generado el 2026-09-17 · 323 registros · 22 meses<!-- END:footer --></sub> · <sub>Estructura: [SCHEMA.md](../../SCHEMA.md) · Datos: [dist/](../../dist/README.md)</sub>
