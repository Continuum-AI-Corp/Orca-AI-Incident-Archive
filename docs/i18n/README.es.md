...
|  |  |
|---|---|
| Enlaces de fuentes | 597 enlaces de 530 URL únicas |
| Registros sin fuente | **0** — sin fuente no hay registro |
| Grado A (fuente primaria) | 287 |
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {335 registros, de 2025-01 a 2026-09; 125 con daño real confirmado},
...
<sub><!-- BEGIN:footer -->Generado el 2026-09-19 · 335 registros · 22 meses<!-- END:footer --></sub> · <sub>Estructura: [SCHEMA.md](../../SCHEMA.md) · Datos: [dist/](../../dist/README.md)</sub>
