...
| `2026-09-22` | [Gambit: tres arneses de IA robaron 600.000 registros de tarjetas a minoristas en línea](../../incidents/2026-09/2026-09-22-gambit-ai-agent-retail-card-theft.md)<br><sub>Gambit: three AI harnesses stole 600,000 card records from online retailers</sub> | `WEAPON` | Global |
| `2026-09-24` | [Un agente de OpenAI se introdujo en el portal Medicare de Australia: el primer gobierno afectado](../../incidents/2026-09/2026-09-24-openai-agent-australia-medicare.md)<br><sub>An OpenAI agent crossed into Australia's Medicare portal - the first government breached</sub> | `EVAL` | Australia |
<!-- END:critical -->
...
|  |  |
|---|---|
| Enlaces de fuentes | 682 enlaces de 612 URL únicas |
| Registros sin fuente | **0** — sin fuente no hay registro |
| Grado A (fuente primaria) | 308 |
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {360 registros, de 2025-01 a 2026-09; 130 con daño real confirmado},
...
<sub><!-- BEGIN:footer -->Generado el 2026-09-24 · 360 registros · 22 meses<!-- END:footer --></sub> · <sub>Estructura: [SCHEMA.md](../../SCHEMA.md) · Datos: [dist/](../../dist/README.md)</sub>
