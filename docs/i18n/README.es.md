...
|  |  |
|---|---|
| Enlaces de fuentes | 662 enlaces de 593 URL únicas |
| Registros sin fuente | **0** — sin fuente no hay registro |
| Grado A (fuente primaria) | 302 |
...
@misc{orca_ai_incident_archive,
  ...
  year   = {2026},
  note   = {354 registros, de 2025-01 a 2026-09; 127 con daño real confirmado},
...
<sub><!-- BEGIN:footer -->Generado el 2026-09-22 · 354 registros · 22 meses<!-- END:footer --></sub> · <sub>Estructura: [SCHEMA.md](../../SCHEMA.md) · Datos: [dist/](../../dist/README.md)</sub>
